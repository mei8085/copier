...
def test_save_answersfile_data_multiple_profiles(tmp_path: Path) -> None:
    ...
    save_answersfile_data(tmp_path, ".copier-answers.yml", dev_answers, profile="dev")
...
def test_save_answersfile_data_update_existing_profile(tmp_path: Path) -> None:
    ...
    save_answersfile_data(tmp_path, ".copier-answers.yml", initial_answers, profile="dev")
